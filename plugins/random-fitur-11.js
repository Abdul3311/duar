...
handler.command = handler.help = ['umma', 'dlanoboy', 'animesearch', 'animesearchv2', 'mangasearch', 'mangasearchv2', 'kusonime2', 'anoboy', 'sfilesearch', 'stikwa', 'apk', 'gbwa', 'stiktele', 'ytmp4dl', 'ytmp3dl', 'playmp4', 'tiktok3', 'mediafire3', 'twittervid', 'twitterimg', 'asupan']
handler.tags = ['random']
